...
ФУНКЦИИ: возвращ. тип любой кроме массива и функции, но может быть указатель на массив или ф-цию
	-static
СТЕК
	аргументы, адрес возврата, адреса вложенных кадров(адреса на локальные переменные вызывающего метода), локальные переменные, сохраненные регистры процессора
